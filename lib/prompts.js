...
LANGUAGE HINTS:
- "teal", "blue", "green", "bluish", "greenish", "cyan", "turquoise", "aqua", "blue-green", "blue green", "ocean colored", "ocean blue", "sea green", "mint" -> color_teal. The teal aliens read as blue on some screens and green on others, so treat BLUE, GREEN, and TEAL as the SAME color: always map any of them to color_teal as a confident "matched" (do NOT mark blue or green as ambiguous or off_topic just because the catalog word is "teal"). There is no separate blue or green alien — teal is the only blue/green color.
